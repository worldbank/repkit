...
{hline}
{pstd}help file for {hi:reproot_setup_dlg_output}{p_end}
{hline}

{title:Title}

{phang}{bf:reproot_setup_dlg_output} - This command is used for short description.
{p_end}

{title:Syntax}

{phang}{bf:reproot_setup_dlg_output} , {bf:{ul:opt}ion1}({it:string})
{p_end}
